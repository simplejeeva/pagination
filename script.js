...
var data=[
  ...
  function child_clicked(e){
    document.querySelector('.parent_data').innerHTML=''
 ...
 <p for="email">${obtained_data.email}</p>
  ...
  `
  document.querySelector('.parent_data').append(creating_div)
}

btn_Next.addEventListener('click',()=>{
    console.log('clicked');
    var user_data=100
    var iter_val=(parseInt(user_data/10-1))*10
...
if(iter_val>=attribute_val){
    var increasing_attributes_val=attribute_val+10

taking_for.setAttribute('for',increasing_attributes_val)

taking_for.innerText= increasing_attributes_val
    }
}
